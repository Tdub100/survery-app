...
module.exports = configure(function ( ctx ) {
  return {
    ...
    build: {
      ...
      env: {
        SERVER_URL: ctx.dev ? 'http://localhost:3000' : 'http://54.164.21.246',
        CREATOR_NAME: 'Tahmir Williams',
        CREATOR_EMAIL: 'tahmirw@nycstudents.net',
        LINKEDIN: 'https://www.linkedin.com/in/tahmirwilliams/'
      },
